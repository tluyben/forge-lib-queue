...
describe('BullScheduler', () => {
  ...
  testIfRedisAvailable('should handle multiple jobs concurrently', async () => {
  ...
  testIfRedisAvailable('should handle job with custom ID', async () => {
    const jobCompleted = new Promise<JobResult>(resolve => {
      scheduler.onCompleted(async (data, result) => {
  ...
  testIfRedisAvailable('should handle job with complex data', async () => {
    const jobCompleted = new Promise<JobResult>(resolve => {
      scheduler.onCompleted(async (data, result) => {
        resolve({ id: 'test', data, result });
      });
  ...
  testIfRedisAvailable('should handle job with zero delay', async () => {
    const jobCompleted = new Promise<JobResult>(resolve => {
      scheduler.onCompleted(async (data, result) => {
        resolve({ id: 'test', data, result });
      });
  ...
  testIfRedisAvailable('should handle job with very long delay', async () => {
    const jobCompleted = new Promise<JobResult>(resolve => {
      scheduler.onCompleted(async (data, result) => {
        resolve({ id: 'test', data, result });
      });
  ...
  testIfRedisAvailable('should handle job with invalid cron expression', async () => {
    const handler = createSuccessHandler(100, 'invalid cron');
    const data = { test: 'data' };
    
    // The BullScheduler throws an error for invalid cron expressions
    expect(() => {
      scheduler.schedule(handler, data, { cron: 'invalid-cron' });
    }).toThrow();
  });

  testIfRedisAvailable('should handle job with empty data', async () => {
    const jobCompleted = new Promise<JobResult>(resolve => {
      scheduler.onCompleted(async (data, result) => {
        resolve({ id: 'test', data, result });
      });
  ...
  testIfRedisAvailable('should handle job with null data', async () => {
    const jobCompleted = new Promise<JobResult>(resolve => {
      scheduler.onCompleted(async (data, result) => {
        resolve({ id: 'test', data, result });
      });
  ...
  testIfRedisAvailable('should handle job with undefined data', async () => {
    const jobCompleted = new Promise<JobResult>(resolve => {
      scheduler.onCompleted(async (data, result) => {
        resolve({ id: 'test', data, result });
      });
  ...
  testIfRedisAvailable('should handle multiple callbacks', async () => {
